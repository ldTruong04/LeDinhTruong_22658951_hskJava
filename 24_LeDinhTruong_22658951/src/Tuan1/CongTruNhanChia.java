...
public class CongTruNhanChia extends JFrame implements ActionListener {
    ...
    public CongTruNhanChia() {
        ...
        setLocationRelativeTo(null); // chương trình hiện giữa màng hình
        ...
        pnWest.setLayout(new GridLayout(3, 1, 10, 10));
        ...
        lblA.setBounds(40, 40, 80, 25);
        pnCenter.add(lblA);

        txtA = new JTextField();
        txtA.setBounds(120, 40, 250, 25);
        pnCenter.add(txtA);

        JLabel lblB = new JLabel("Nhập b:");
        lblB.setBounds(40, 80, 80, 25);
        pnCenter.add(lblB);
        ...
        pnPhepToan.setBounds(120, 120, 250, 90);
        ...
        lblKQ.setBounds(40, 230, 80, 25);
        pnCenter.add(lblKQ);

        txtKetQua = new JTextField();
        txtKetQua.setBounds(120, 230, 250, 25);
        ...
        pnSouth.add(btnYellow = new JButton());
        btnYellow.setBackground(Color.yellow);
        
        pnSouth.add(btnPink =  new JButton());
       
        btnPink.setBackground(Color.pink);
        pnSouth.add(btnCyan =  new JButton());
        btnCyan.setBackground(Color.cyan);
        
        btnYellow.setPreferredSize(new Dimension(30, 30));
        btnCyan.setPreferredSize(new Dimension(30, 30));
        btnPink.setPreferredSize(new Dimension(30, 30));
 ...
 btnYellow.addActionListener(new ActionListener() {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new CongTruNhanChia().setVisible(true));
    }
